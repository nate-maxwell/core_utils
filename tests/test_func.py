...
class TestOnce:
    ...
    def test_return_value_is_returned_on_first_call(self) -> None:
        @func.once
        def fn() -> int:
            return 42
    ...
    def test_return_value_is_returned_on_subsequent_calls(self) -> None:
        @func.once
        def fn() -> int:
            return 42
    ...
    def test_none_return_value_is_preserved(self) -> None:
        @func.once
        def fn() -> None:
            return None
